...
;$.fn.eventCalendar = function(options){
	...
	this.each(function(){
		...
		flags.wrap = $(this);
		flags.wrap.addClass('eventCalendar-wrap').append("<div class='eventsCalendar-list-wrap'><p class='eventsCalendar-subtitle'></p><span class='eventsCalendar-loading'>加载中...</span><div class='eventsCalendar-list-content'><ul class='eventsCalendar-list'></ul></div></div>");
			...
			if (data.length) {
				...
				$.each(data, function(key, event) {
					...
					if (limit === 0 || limit > i) {
						...
						//var eventMonthToShow = eventMonth,
	...
	function setCalendarWidth(){
		...
		flags.wrap.find('.eventsCalendar-monthWrap').width( '250px');
		//flags.wrap.find('.eventsCalendar-list-wrap').width(flags.wrap.width() + 'px');
		flags.wrap.find('.eventsCalendar-list-wrap').width('440px');
	}
};
